...
# pedimos que mire cuál es el valor de recuencia más alto y nos devuelva su
...
# 11) Medidas de forma. Calcular la asimetría y curtósis de qsec
library(e1071) # activamos la librería
